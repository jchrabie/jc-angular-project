export const experiences: Experience[] = [
  ...
  },
  {
    ...
    chips: ['Angular', 'TypeScript', 'Node', 'JavaScript', 'Sass', 'HTML5', 'jQuery'],
    showMore: true,
  },
  {
    ...
    chips: ['Angular', 'Node', 'JavaScript', 'TypeScript', 'Sass', 'HTML5', 'Mustache', 'jQuery', 'Gulp', 'WebPack'],
    showMore: true,
  },
  {
